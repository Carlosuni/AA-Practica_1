...
class BustersKeyboardAgent(BustersAgent, KeyboardAgent):
	...
	def getAction(self, gameState):
		self.keyboard_action = BustersAgent.getAction(self, gameState)
	...
	def printLineData(self, gameState, f):
		...
		if self.countActions > 1:
			added_line = self.lineDataBusters + str(self.keyboard_action) + "," + str(gameState.getScore()) + "\n"
			f.write(added_line)
	...
	def actData(self, gameState):
		dir_actual = str(gameState.data.agentStates[0].getDirection())
		if dir_actual == None:
			dir_actual = "None"
		...
		self.lineDataBusters = str(self.countActions) + "," + str(gameState.data.layout.width) + "," + str(gameState.data.layout.height) + "," + \
							   str(gameState.getPacmanPosition()[0]) + "," + str(gameState.getPacmanPosition()[1]) + "," + str(accionesLegales) + \
							   dir_actual + "," + str(
			gameState.getNumAgents() - 1) + "," + \
							   str(gameState.getLivingGhosts()[0]) + "," + str(gameState.getLivingGhosts()[1]) + "," + str(gameState.getLivingGhosts()[2]) + "," + str(gameState.getLivingGhosts()[3]) + "," + str(gameState.getLivingGhosts()[4]) + "," + str(gameState.getGhostPositions()[0][0]) + "," + str(gameState.getGhostPositions()[0][1]) + "," + str(gameState.getGhostPositions()[1][0]) + "," + str(gameState.getGhostPositions()[1][1]) + "," + str(gameState.getGhostPositions()[2][0]) + "," + str(gameState.getGhostPositions()[2][1]) + "," + str(gameState.getGhostPositions()[3][0]) + "," + str(gameState.getGhostPositions()[3][1]) + "," + \
							   str(gameState.getGhostDirections().get(0)) + "," + str(gameState.getGhostDirections().get(1)) + "," + str(gameState.getGhostDirections().get(2)) + "," + str(gameState.getGhostDirections().get(3)) + "," + \
							   str(dist_g1) + "," + str(dist_g2) + "," + str(dist_g3) + "," + str(dist_g4) + "," + str(gameState.getNumFood()) + "," + \
